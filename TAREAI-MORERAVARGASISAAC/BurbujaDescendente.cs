...
{
    class BurbujaDescendente
    {

        public void BurbujaOrdenarDescendente(int[] preciolista, string[] nombrelista)//funcion metodo burbuja que recibe parametros
        {
            ...
            Console.Clear();
            Console.WriteLine("SE FINALIZO AL ORDENAR LA LISTA DE MAYOR A MENOR\nPRESIONE UNA TECLA PARA SEGUIR");
            Console.ReadKey();
            Console.Clear();
        }
    }
